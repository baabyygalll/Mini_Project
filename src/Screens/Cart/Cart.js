...
function Cart(value) {
  ...
  useEffect(() => {
    ...
    const updateValue = getKeranjangAll.data?.keranjang.reduce(
  ...
  return (
    <div>
      ...
      {getKeranjangAll.loading === true ? (
        <img
          src="assets\images\loading-animation\infinity.svg"
          className="loadingg"
        />
              ...
              <Row>
                <Col>
                  <ListGroup.Item style={{ border: "none" }}>
                    ...
                    <span>Rp {numberWithCommas(keranjangs.harga)}</span>{" "}
                    <br></br>
                    ...
                    <button
                      onClick={() => handlePlus(keranjangs.id)}
      ...
      <div
        ...
        style={{ marginLeft: "90rem", marginTop: "10rem" }}
      >
        {" "}
